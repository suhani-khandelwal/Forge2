...
export const getCompetitiveIntelligence = (category: string, tags: string[], name: string): CompetitiveIntelligence => {
  ...
  if (searchTerm.includes('sun') || searchTerm.includes('spf') || searchTerm.includes('uv')) {
    return {
      ...
      competitors: [
        { brand: "The Derma Co", product_name: "1% Hyaluronic Sunscreen Aqua Gel", price: "₹499", spf_or_strength: "SPF 50 PA++++", key_ingredients: ["Hyaluronic Acid", "Vitamin E", "Titanium Dioxide"], skin_type_or_target: "All Skin Types", claims: ["No White Cast", "Broad Spectrum", "Fragrance-Free"], rating: "4.4/5", platform: "Nykaa", product_url: "https://the-derma-co.com/product/1-hyaluronic-sunscreen-aqua-gel" },
        { brand: "Aqualogica", product_name: "Glow+ Dewy Sunscreen", price: "₹399", spf_or_strength: "SPF 50 PA++++", key_ingredients: ["Vitamin C", "Papaya Extracts", "Zinc Oxide"], skin_type_or_target: "Dry/Combination", claims: ["Dewy Finish", "Water Light", "Blue Light Protection"], rating: "4.5/5", platform: "Amazon India", product_url: "https://aqualogica.in/product/glow-dewy-sunscreen" },
        { brand: "Minimalist", product_name: "Light Fluid SPF 50", price: "₹499", spf_or_strength: "SPF 50", key_ingredients: ["UV Filters", "Glycerin"], skin_type_or_target: "Oily/Acne Prone", claims: ["Non-comedogenic", "Photostable"], rating: "4.3/5", platform: "Official Website", product_url: "https://beminimalist.co/products/spf-50-sunscreen" },
